...
- ใช้ [แบบฟอร์มรายงานบัก](https://github.com/VarakornUnicornTech/roundtable-framework/issues/new?template=bug_report.md)
...
- ใช้ [แบบฟอร์มเสนอฟีเจอร์](https://github.com/VarakornUnicornTech/roundtable-framework/issues/new?template=feature_request.md)
...
- **คำถาม:** ใช้ [GitHub Discussions](https://github.com/VarakornUnicornTech/roundtable-framework/discussions)
- **บัก:** ใช้ [Issues](https://github.com/VarakornUnicornTech/roundtable-framework/issues)
- **ฟีเจอร์:** ใช้ [Issues](https://github.com/VarakornUnicornTech/roundtable-framework/issues)
